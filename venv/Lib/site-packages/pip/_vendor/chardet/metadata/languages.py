...
LANGUAGES = {
    ...
    iso_code="hi",
    use_ascii=False,
    charsets=["UTF-8", "WINDOWS-1252"],  # UTF-8 is the safe default for Devanagari
    alphabet="ऀँंःऄअआइईउऊऋॠऌॡएऐओऔकखगघङचछजझञटठडढणतथदधनपफबभमयरलवशषसह़ऽािीुूृॄॢॣेैोौ्॒॑॓॔",
    wiki_start_pages=["मुखपृष्ठ"]
    ),
    ...
    alphabet="ಅಆಇಈಉಊಋೠಌೡಎಏಐಒಓಔಕಖಗಘಙಚಛಜಝಞಟಠಡಢಣತಥದಧನಪಫಬಭಮಯರಲವಶಷಸಹಳೞಂಃಽಾಿೀುೂೃೄೆೇೈೊೋೌ್ೕೖ",
    wiki_start_pages=["ಮುಖ್ಯ_ಪುಟ"]
    ),
    "Lithuanian": Language(
        name="Lithuanian",
        iso_code="lt",
